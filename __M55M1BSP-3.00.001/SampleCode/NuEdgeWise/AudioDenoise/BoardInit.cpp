...
static void SYS_Init(void)
{
    ...
    /* Enable SDH0 module clock source as APLL1 and SDH0 module clock divider as 5 */
...
int BoardInit(void)
{
    ...
    /* Configure PH.1 as Input mode and enable interrupt by rising edge trigger. In order to switch denoise or not*/
    GPIO_SetMode(PH, BIT1, GPIO_MODE_INPUT);
    GPIO_EnableInt(PH, 1, GPIO_INT_RISING);
