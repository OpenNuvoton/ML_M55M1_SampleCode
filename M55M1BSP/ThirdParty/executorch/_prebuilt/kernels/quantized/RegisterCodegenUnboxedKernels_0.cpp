...
static Kernel kernels_to_register[] = {
    ...
    Kernel(
    	...
    	torch::executor::Tensor & zero_point_out_base = zero_point_out.to<torch::executor::Tensor>();
            ...
            internal::EventTracerProfileScope event_tracer_scope(context.internal_event_tracer(), "native_call_choose_qparams.Tensor_out");
    ...
    Kernel(
    	...
    	torch::executor::ScalarType dtype_base = dtype.to<torch::executor::ScalarType>();
    	    ...
    	    torch::executor::optional<torch::executor::ScalarType> out_dtype_opt_out = out_dtype.toOptional<torch::executor::ScalarType>();
    	            
    	torch::executor::Tensor & out_base = out.to<torch::executor::Tensor>();
    
            internal::EventTracerProfileScope event_tracer_scope(context.internal_event_tracer(), "native_call_dequantize_per_tensor.out");
    ...
    Kernel(
    	...
    	torch::executor::Tensor & out_base = out.to<torch::executor::Tensor>();
            ...
            internal::EventTracerProfileScope event_tracer_scope(context.internal_event_tracer(), "native_call_dequantize_per_tensor.Tensor_out");
    ...
    Kernel(
    	...
    	torch::executor::Tensor & out_base = out.to<torch::executor::Tensor>();
            ...
            internal::EventTracerProfileScope event_tracer_scope(context.internal_event_tracer(), "native_call_quantize_per_channel.out");
    ...
    Kernel(
    	...
    	const torch::executor::Tensor & scales_base = scales.to<torch::executor::Tensor>();
    	    ...
    	    torch::executor::optional<torch::executor::Tensor> zero_points_opt_out = zero_points.toOptional<torch::executor::Tensor>();
    	...
    	torch::executor::Tensor & out_base = out.to<torch::executor::Tensor>();
            ...
            internal::EventTracerProfileScope event_tracer_scope(context.internal_event_tracer(), "native_call_dequantize_per_channel.out");
    ...
    Kernel(
    	...
    	const torch::executor::Tensor & weight_scales_base = weight_scales.to<torch::executor::Tensor>();
    	    ...
    	    torch::executor::optional<torch::executor::Tensor> weight_zero_points_opt_out = weight_zero_points.toOptional<torch::executor::Tensor>();
    	...
    	torch::executor::Tensor & out_base = out.to<torch::executor::Tensor>();
            ...
            internal::EventTracerProfileScope event_tracer_scope(context.internal_event_tracer(), "native_call_embedding_byte.out");
    ...
    Kernel(
    	...
    	torch::executor::Tensor & out_base = out.to<torch::executor::Tensor>();
            ...
            internal::EventTracerProfileScope event_tracer_scope(context.internal_event_tracer(), "native_call_embedding_byte.dtype_out");
    ...
    Kernel(
    	...
    	torch::executor::Tensor & out_base = out.to<torch::executor::Tensor>();
            ...
            internal::EventTracerProfileScope event_tracer_scope(context.internal_event_tracer(), "native_call_embedding_4bit.out");
    ...
    Kernel(
    	...
    	torch::executor::Tensor & out_base = out.to<torch::executor::Tensor>();
            ...
            internal::EventTracerProfileScope event_tracer_scope(context.internal_event_tracer(), "native_call_embedding_4bit.dtype_out");
    ...
    Kernel(
    	...
    	torch::executor::Tensor & out_base = out.to<torch::executor::Tensor>();
            ...
            internal::EventTracerProfileScope event_tracer_scope(context.internal_event_tracer(), "native_call_mixed_mm.out");
    ...
    Kernel(
    	...
    	torch::executor::Tensor & out_base = out.to<torch::executor::Tensor>();
            ...
            internal::EventTracerProfileScope event_tracer_scope(context.internal_event_tracer(), "native_call_mixed_linear.out");
    ...
    Kernel(
    	...
    	torch::executor::Tensor & out_base = out.to<torch::executor::Tensor>();
            ...
            internal::EventTracerProfileScope event_tracer_scope(context.internal_event_tracer(), "native_call_quantize_per_tensor.Tensor_out");
