 ...
 * Register ArmBackend to exectorch runtime 
 */
...
//////////////////////////////////////////////////////////////////
// ArmBackend class implementation
/////////////////////////////////////////////////////////////////

namespace torch {
namespace executor {

// SRAM (rwx) : ORIGIN = 0x20100000, LENGTH = 0x00150000
#define M55M1_SRAM012_LOW	((void*)0x20100000)
#define M55M1_SRAM012_HIGH	((void*)0x2024FFFF)
...
class ArmBackend final : public PyTorchBackendInterface {
 public:
  ...
  Result<DelegateHandle*> init(
    ...
    if (!(data > M55M1_SRAM012_LOW && foot < M55M1_SRAM012_HIGH)) {
...
/// Ethos-U backend instance
static auto ethosu_backend = ArmBackend();

Error register_ethosu_backend() {

 	Backend backend_id{"ArmBackend", &ethosu_backend};
	static auto success_with_backend_reg = register_backend(backend_id);
	
    if(success_with_backend_reg != Error::Ok) {
        ET_LOG(Error, "Failed register ethosu backend");
    }
    return success_with_backend_reg;
}
