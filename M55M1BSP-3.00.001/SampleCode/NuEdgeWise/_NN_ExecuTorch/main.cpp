...
//#include "model_add_pte.h"
#include "mnist_cnn.pt_arm_delegate.pte.h"
...
void helper_print_model_input_tensor_info(Method& method)
{
  ...
  for (size_t i = 0; i < num_inputs; i++) {
    ...
    ET_LOG(Info, "Input tensor data type %s ", toString(tensor_meta->scalar_type()));
...
int main() {
  ...
  ET_LOG(Info, "Model PTE file loaded. Size: %u bytes.", sizeof(model_pte));
