/**************************************************************************//**
 * @file     YOLOv11nODModel.hpp
 * @version  V1.00
 * @brief    YOLOv11n object detection model header file
 *
 * @copyright SPDX-License-Identifier: Apache-2.0
 * @copyright Copyright (C) 2024 Nuvoton Technology Corp. All rights reserved.
 ******************************************************************************/
#ifndef _YOLOV11N_OD_MODEL_HPP_
#define _YOLOV11N_OD_MODEL_HPP_
...
#define MODEL_OUTPUT_OBJECT_TENSOR	(0)
...
class YOLOv11nODModel : public Model
{
