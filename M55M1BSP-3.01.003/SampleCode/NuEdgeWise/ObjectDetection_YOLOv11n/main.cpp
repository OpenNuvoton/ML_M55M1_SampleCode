...
#include "YOLOv11nODModel.hpp"       /* Model API */
...
typedef struct
{
    ...
    image_t frameImage;
    std::vector<arm::app::yolov11n_od::DetectionResult> results;
} S_FRAMEBUF;
...
static void DrawDetectBox(
    const std::vector<arm::app::yolov11n_od::DetectionResult> &results,
    image_t *drawImg,
    std::vector<std::string> &labels
)
{
    arm::app::yolov11n_od::DetectionResult detectBox;
...
{
#define MODEL_FILE "0:\\YOLOv11n-od.tflite"
...
int main()
{
    ...
    printf("Please copy ObjectDetection_YOLOv11n/Model/YOLOv11n-od.tflite to SDCard:/YOLOv11n-od.tflite \n");
    printf("===================================================================================\n");
    ...
    const int inputImgCols = inputShape->data[arm::app::YOLOv11nODModel::ms_inputColsIdx];
    const int inputImgRows = inputShape->data[arm::app::YOLOv11nODModel::ms_inputRowsIdx];
    const uint32_t nChannels = inputShape->data[arm::app::YOLOv11nODModel::ms_inputChannelsIdx];

    /* Get input quantization params information. */
    arm::app::QuantParams inQuantParams = arm::app::GetTensorQuantParams(inputTensor);

    // postProcess
    arm::app::yolov11n_od::YOLOv11nODPostProcessing postProcess(&model, OD_PRESENCE_THRESHOLD);
